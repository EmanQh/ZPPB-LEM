...
Refer to the [MP-SPDZ Documentation](https://mp-spdz.readthedocs.io) for detailed instructions on how to run the programes in the ``Source`` folder of this repository using any of MPC protocols supported by MP-SPDZ. 
